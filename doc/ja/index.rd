...
((<インストール|URL:install/>))ページで説明しています。

== 使い方

((<使い方|URL:usage.html>))ページで説明しています。

== スライドの作り方

((<スライドの作り方|URL:how-to-make/>))ページで説明しています。
...
((<ユーザー|URL:users.html>))ページにメーリングリストへの参
加方法があります。
